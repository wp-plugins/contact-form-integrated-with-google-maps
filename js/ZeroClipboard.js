   ...
   var element = currentElement;
    ...
    switch (eventName) {
     ...
     case "datarequested":
      ...
      var targetId = element.getAttribute("data-shortcode-target"), targetEl = !targetId ? null : document.getElementById(targetId);
      ...
      break;
     case "complete":
	 if(jQuery(element).attr('data-shortcode-target')){
             jQuery(element).text('Copied');
		 }
      this.options.text = null;
      break;
    }
