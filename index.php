...
function fggm_admin_notice() {
    ...
    if ($pos == false) {
        ...
        if (!get_user_meta($user_id, 'admin_ignore_notice')) {
            ?>
            <div class="fggm_trial-notify">
                <p>
                    <a href='<?php echo admin_url('admin.php?page=fggm_page'); ?>'>Click to Create your own Advance Contact Form.</a> You can add your built form to any Page, Post, Sidebar or as a Tabbed Content.<?php printf(__('<a class="fggm_hide_notice", href="%1$s">Hide Notice</a>'), '?admin_nag_ignore=0'); ?></p>
            </div>
            <?php
        }
    }
...
function fggmgm_setting_page() {
	...
	<div class="fg_upgarde_to_pro" id="fg_upgarde_to_pro">
			 ...
			 <a href="http://www.formget.com/app/pricing" target="_blank"><div class="button_to_formget" id="button_to_upgrade" style="margin-right: 15px;">UPGRADE TO PRO </div></a>
			  <a href="http://www.formget.com/" target="_blank"><div class="button_to_formget" id="button_to_site" style="float:left; margin-right:30px;">Visite Site </div></a>
		</div>
	<div id="fggm_of_container" class="fggm_wrap">
            ...
            <div id="fggm_main">
                ...
                <div id="fggm_of-nav">
                    <ul>
                        ...
                        <li> <a class="pn-view-a" href="#pn_fgtutorial" title="Video Tutorials">Video Tutorials</a></li>
     ...
     <div class="fggm_group" id="pn_fgtutorial">
                        <h2> Following are the FormGet tutorials that will help you to understand FormGet</h2>

                        <div class="fggm_section section-text">
                            <h3></h3>
                            <iframe src="http://www.formget.com/formget-video-tutorials-guide/" name="iframe" style="width:1010px; height:900px; overflow-y:scroll;" >
                                    </iframe>
                        </div>
...
if (!function_exists('display_iframe_form')) {
    ...
    function display_iframe_form() {
        ...
        if ($pos == true) {
        ?>
        <div class="fggmgm_contac_us_img" id="fggmgm_contac_us_img" style="display:none"><img src="http://www.formget.com/app/code/contact_tab?c=Contact Us&amp;t_color=ffffff&amp;b_color=7d9f2b&amp;f_size=18" alt="Feedback &amp; Support" style="border:0; background-color: transparent; padding-left:7px; margin:0; padding-top: 40px;"> </div>
        <div id="fggmgm-box-popup"  style="display:none">
            <div id="fggmgm_form_show">
                ...
                <div class="fggm_form_area fg_display_form" >
