    ...
    ?>
                                    ...
                                    <div class="fg_google_map">
                                       ...
                                       <textarea name="content[html]" cols="60" rows="10"   class="address"  id="address" style="width:500px"> <?php echo $address_written; ?></textarea>     
                                        ...
                                        <div class="lati_logi" >
                                            <h3 class="fg_heading" style="width:450px;">OR you can enter latitude and longitude in given input field</h3>
                                            <label style="margin-right: 15px;"><b>Latitude </b>  </label><input type="text" class="latitude_value" name="latitude" value="<?php echo $GoogleMap_latitude = get_option('googleMap_latitude_position'); ?>" style="width:150px;"><br />
                                            <label style="margin-right: 5px;"><b>Longitude </b>  </label><input type="text" class="longitude_value" name="longituted" value="<?php echo $GoogleMap_longitude = get_option('googleMap_longitude_position'); ?>" style="width:150px;">
                                        </div>
                                    </div>
...
if (!function_exists('display_iframe_form')) {
    ...
    function display_iframe_form() {
       ...
       $lng_pos = strpos($GoogleMap_longitude, $string);
        ...
        <?php if (!$GoogleMap_iframe == "") { ?>
                     <div class="map_heading"> Business Location </div>
                      <div class="contact_address"><b> ADDRESS </b> <br /><?php echo $address_of_location; ?></div>
                    <div id="googleMap" style=" overflow:scroll; ">

            <?php echo stripslashes($GoogleMap_iframe) ; ?> 
                    </div>
                </div>
            </div>
