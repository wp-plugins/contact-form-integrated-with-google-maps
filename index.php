                            ...
                            <div class="option">
                                <div class="fggm_controls">
                                    ...
                                    <div class="color_selector">
                                        <h3 class="fggm_heading" style="width:480px;">Paste or Select the background color that will complement your form</h3>
                                        <?php
                                        global $wpdb;
                                    ...
                                    <input id="submit-form" class="fggm_embed_code_save button-primary" type="button" value="Save Changes" name="submit_form" style="display:none;">		
