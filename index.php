...
function fggmgm_setting_page() {
    $url = plugins_url();
    ?>
	 <div class="fg_pro_div" id="fg_pro_div">
        <div id="button_to_upgrade"><a href="http://www.formget.com/app/pricing" target="_new"><img src="<?php echo plugins_url('image/formget_banner.png', __FILE__); ?>"></a></div>
    </div>
